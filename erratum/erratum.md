...
Subsequently the learning rules in Eq. (7) in the article, and Eqs. (3) and (4) in the Supplementary Material, which were derived from the erroneous expression are also affected. 
